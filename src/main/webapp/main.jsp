...
<body>
	<main>
		...
		<p class="content">
			미 뮤지엄은 오프라인과 온라인의<br>
			경계를 넘어선 미술관입니다.<br>
			전시 관람 뿐 아니라 창작자와 관람자와의<br>
			허들을 허물어 모든이가 예술가가 되는 날을 꿈꿉니다.<br>
			언제라도 방문하셔서 다양한 프로그램을 <br>
			즐기시기를 바랍니다.<br>
			감동과 상상력을 주는 미술관으로 <br>
			여러분을 초대합니다.<br>
		</p>
		<footer>
...
ChannelIO('boot', {
  "pluginKey": "3695149b-9582-40d0-83f8-0f3e68e3f988"
});
</script>
